 ...
 * @returns {string}
 */
export function decrypt(enc_envelope, password, auth_type) {
    let deferred5_0;
    let deferred5_1;
    try {
 ...
 * @returns {string}
 */
export function createNewVault(password, biometric_key) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.createNewVault(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function createWalletFromMnemonic(mnemonic, password, biometric_key) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ret = wasm.createWalletFromMnemonic(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
